...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        TeamMember(
            student_id="2412878",
            full_name="Jake Laurence Pontanal",
            role="Requirements Engineer & UI/UX Lead",
            specialization="Flet Reactive Widgets & Material 3 Layouts",
            github_handle="@jakelaurence",
            avatar_icon=ft.Icons.PALETTE,
            accent_color=ft.Colors.PINK_500,
            photo_url="https://github.com/jakelaurence.png",
        ),
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2412876",  # example: "2024-10789"
            full_name="Kurt Hearick Mangente", # example: "Angelo Reyes"
            role="QA & Feature Engineer",
            specialization="Testing Diagnostics, Theme Engine & Controls",
            github_handle="@krtmangen10",          # example: "@areyes-cspc"
            avatar_icon=ft.Icons.BUG_REPORT,
            accent_color=ft.Colors.INDIGO_700,
            photo_url="https://github.com/kumangen10.png",                 # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
